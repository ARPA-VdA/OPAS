...
#------------------------------------------------------------------------------
#
#   Script Name : report-manutenzione.pl
...
#
#   RUN EXAMPLE:
#       (ma_id)   $ perl /path/to/script/report-manutenzione.pl 16
#
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
...
my $title    = 'Reports';
my $location = 'Opas';
my $logfile  = 'report-manutenzione.log';
my $version  = '1.0';
...
my $tex_file_wrapper = $working_path.'/report_manutenzione_'.$random_str.'.tex';
my $tex_file_body = $working_path.'/manutenzione_'.$random_str.'.tex';
my $tex_file_headfoot = $working_path.'/header_footer_manutenzione_'.$random_str.'.tex';
...
#------------------------------------------------------------------------------
# GET RECORD MANUTENZIONE
#------------------------------------------------------------------------------
my $maintenance = dbh_get_row_hashref( $sql_main );
$log->info(Dumper($maintenance));
...
# HEADER/FOOTER
#------------------------------------------------------------------------------
$log->debug('header-footer manutenzione ...');
...
# CORPO CENTRALE
#------------------------------------------------------------------------------
$log->debug('corpo centrale manutenzione ...');
...
$body .= '    \textcolor{BOBOblue}{\Large{Report Manutenzione n. \textbf{'.$maintenance->{ma_id}.'} del \textbf{'.$maintenance->{date}.'} alle \textbf{'.$maintenance->{time_format}.'}}} % TITOLO'."\n";
$body .= '\end{center}'."\n";
...
# corpo tabelle
$body .= '\textcolor{blueCF}{\bfseries{\large Operazioni svolte}}'."\n";
$body .= '\begin{center}'."\n";
...
$body .= '        \endfirsthead'."\n";
$body .= "\n";
$body .= '        \multicolumn{2}{l}{\textcolor{blueCF}{\mdseries{\textit{Continua dalla pagina precedente...}}}} & & & & \\\\'."\n";
$body .= '        \bfseries{Strumento} & \bfseries{Operazione} & \bfseries{Frequenza} & \bfseries{Taratura} & \bfseries{Scad. filtri} & \bfseries{Note} \\\\'."\n";
$body .= '        \arrayrulecolor{lines}\hline'."\n";
$body .= '        \arrayrulecolor{lines}\hline'."\n";
$body .= '        \endhead'."\n";
$body .= "\n";
$body .= '         & & & & \multicolumn{2}{r}{\textcolor{blueCF}{\mdseries{\textit{Continua nella prossima pagina...}}}} \\\\'."\n";
$body .= '        \endfoot'."\n";
$body .= "\n";
$body .= '        \arrayrulecolor{lines}\hline'."\n";
$body .= '        \arrayrulecolor{lines}\hline'."\n";
...
# loop per popolare la tabella delle operazioni
    ...
    foreach my $calibid ( @calib_ids ) {
        ...
        given ($calibration->{category_id}) {
            when (1) {
                ...
                ##### TABELLA ZERO
                $body .= '\textcolor{blueCF}{\bfseries{\large Taratura dello ZERO}}'."\n";
                $body .= '\begin{center}'."\n";
                $body .= '    \renewcommand{\arraystretch}{1.75}'."\n";
                ...
                if ($calibration->{calib_multipoint}) {
                    $body .= '\textcolor{blueCF}{\bfseries{\large Taratura dello SPAN MULTIPUNTO}}'."\n";
                    $body .= '\begin{center}'."\n";
                    $body .= '    \renewcommand{\arraystretch}{1.75}'."\n";
                    $body .= '    \begin{tabularx}{0.75\textwidth}{'."\n";
                    $body .= '        >{\raggedleft\arraybackslash}X'."\n";
                    ...
                    $body .= '\textcolor{blueCF}{\bfseries{\large Taratura dello SPAN}}'."\n";
                    $body .= '\begin{center}'."\n";
                    $body .= '    \renewcommand{\arraystretch}{1.75}'."\n";
                    $body .= '    \begin{tabularx}{0.75\textwidth}{'."\n";
                    $body .= '        >{\raggedleft\arraybackslash}X'."\n";
            ...
            when ([8, 9, 10, 11, 12, 13]) {
                ...
                ##### TABELLA FLUSSI
                $body .= '\textcolor{blueCF}{\bfseries{\large Taratura dei FLUSSI}}'."\n";
                $body .= '\begin{center}'."\n";
                $body .= '    \renewcommand{\arraystretch}{1.75}'."\n";
            ...
            when ([14, 15, 18]) {
                ...
                ##### TABELLA CANALE
                $body .= '\textcolor{blueCF}{\bfseries{\large Taratura del CANALE}}'."\n";
                $body .= '\begin{center}'."\n";
                $body .= '    \renewcommand{\arraystretch}{1.75}'."\n";
                $body .= '    \begin{tabularx}{0.80\textwidth}{'."\n";
                $body .= '        >{\raggedleft\arraybackslash}X'."\n";
            ...
            when (25) {
                ...
                $body .= '        \arrayrulecolor{lines}\hline'."\n";
                $body .= '        \bfseries{Zero trovato:} & \mdseries{'.check_data_unit(controlnull($calib_json->{'o2-zero-biogas'}), latex_encode("%")).'} &
                                                             \mdseries{'.check_data_unit(controlnull($calib_json->{'ch4-zero-biogas'}), latex_encode(controlnull($calibration->{instr_type_unit}))).'} &
                                                             \mdseries{'.check_data_unit(controlnull($calib_json->{'co2-zero-biogas'}), latex_encode("%")).'} \\\\'."\n";
                $body .= '        \arrayrulecolor{lines}\hline'."\n";
                $body .= '    \end{tabularx}'."\n";
                $body .= '\end{center}'."\n";
                $body .= "\n";
            ...
            when (26) {
                ...
                ##### TABELLA SONDA
                $body .= '\textcolor{blueCF}{\bfseries{\large SONDA}}'."\n";
                $body .= '\begin{center}'."\n";
                $body .= '    \renewcommand{\arraystretch}{1.75}'."\n";
                $body .= '    \begin{tabularx}{0.80\textwidth}{'."\n";
                $body .= '        >{\raggedleft\arraybackslash}X'."\n";
...
# WRAPPER
#------------------------------------------------------------------------------
$log->debug('wrapper manutenzione ...');
...
# PDF FILENAME
#------------------------------------------------------------------------------
my $job_name = 'report-manutenzione'.'-'.sprintf("%06d",$reportid);
