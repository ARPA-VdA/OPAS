...
#------------------------------------------------------------------------------
#
#   Script Name : report-taratura.pl
...
#
#   RUN EXAMPLE:
#       (calib_id)   $ perl /path/to/script/report-taratura.pl 16
#
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
...
my $title    = 'Reports';
my $location = 'Opas';
my $logfile  = 'report-taratura.log';
my $version  = '1.0';
...
my $tex_file_wrapper = $working_path.'/report_taratura_'.$random_str.'.tex';
my $tex_file_body = $working_path.'/taratura_'.$random_str.'.tex';
my $tex_file_headfoot = $working_path.'/header_footer_taratura_'.$random_str.'.tex';
...
# APPUNTI RELATIVI AI CAMPI DELLA QUERY
# calib id = reportid
# inst-type-fullname = nome tipo di strum
# category id = per SO, O£, ecc...
# --> instr_type_fullname (instr_name)

#------------------------------------------------------------------------------
# CAMPI JSON DA DB con esempi
#------------------------------------------------------------------------------
# {
#     'find-zero-ch4' => '',
#     'theory-nox-span-noxnono2' => '',
#     'l2-theory-no-span-noxnono2' => '',
#     'o2-zero-biogas' => '20.85',
#     'tank-span-noxnono2' => '-1',
#     'theory-span-ch4' => '',
#     'no2-zero-noxnono2' => '',
#     'l5-read-span-btx' => '',
#     'method-zero-biogas' => '-1',
#     'l4-theory-no-span-noxnono2' => '',
#     'l4-theory-span-so2' => '',
#     'l4-read-span-so2' => '',
#     'theory-span-aerosol' => '',
#     'press-instr-flow-aerosol' => '',
...
#     'l4-theory-span-o3' => '',
#     'read-no-span-noxnono2' => '',
#     'solution-probe' => '-1',
#     'read-ch4-span-biogas' => '',
#     'l3-theory-span-so2' => '',
#     'find-ben-zero-btx' => '',
#     'method-zero-ch4' => '-1',
#     'tank-zero-so2' => '-1',
...
#     'temp-instr-flow-aerosol' => '',
#     'find-tol-zero-btx' => '',
#     'read-flow-sampler' => '',
#     'l3-theory-span-o3' => '',
#     'l3-read-span-o3' => '',
#     'l4-read-span-co' => '',
#     'read-co2-span-biogas' => '',
#     'l3-read-span-so2' => '',
#     'method-span-noxnono2' => '-1',
#     'read-span-tnmhc' => '',
#     'temp-flow-sampler' => '',
#     'method-span-so2' => '-1',
#     'read-cond-probe' => '',
#     'tank-span-btx' => '-1',
#     'theory-co2-span-biogas' => '',
#     'l2-read-span-co' => '',
#     'nox-zero-noxnono2' => '',
#     'press-flow-aerosol' => '',
#     'read-ben-span-btx' => '',
...
#     'theory-ch4-span-biogas' => '',
#     'l3-read-span-btx' => '',
#     'read-o2-span-biogas' => '',
#     'read-span-co' => '',
#     'method-zero-noxnono2' => '-1',
...
#     'l3-theory-span-co' => '',
#     'reference-flow-aerosol' => '',
#     'l5-theory-span-so2' => '',
#     'theory-redox-probe' => '',
#     'method-span-biogas' => '-1',
#     'read-nox-span-noxnono2' => '',
#     'theory-xil-span-btx' => '',
#     'co2-zero-biogas' => '0.00',
...
my $calibration = dbh_get_row_hashref( $sql );
...
# ESEMPIO DI POPOLAZIONE CAMPI ATTRAVERSO IL JSON
# $calib_json->{"l2-theory-span-so2"}
...
# HEADER/FOOTER
#------------------------------------------------------------------------------
$log->debug('header-footer tarature ...');
...
# CORPO CENTRALE
#------------------------------------------------------------------------------
$log->debug('corpo centrale tarature ...');
...
my ($mod_zero, $mod_span, $mod_flow, $mod_probe);
...
# PDF FILENAME
#------------------------------------------------------------------------------
my $job_name = 'report-taratura'.'-'.sprintf("%06d",$reportid);
