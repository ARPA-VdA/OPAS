...
#------------------------------------------------------------------------------
#
#   Script Name : import-inst.sh
#        Author : Ecometer s.n.c.
#          Date : 2025-03-31
#
#   Download instantaneous data from SFTP server
#
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
...
#--------------------------------------------------------
# # import remote data
# * * * * * ~/bin/arpa_xxxxx/builder/import-inst.sh >> ~/bin/arpa_xxxxx/builder/log/inst_$(date +\%Y\%m\%d).log 2>&1
...
# download data files
#--------------------------------------------------------
LOCAL_DIR="${BASEDIR}/import/inst"
REMOTE_DIR="/arpa.xxxxx/data-inst"
...
#--------------------------------------------------------
/home/opas/perl5/perlbrew/perls/perl-5.38.0/bin/perl "${BASEDIR}/import-inst.pl"
