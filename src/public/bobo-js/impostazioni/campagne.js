...
$(document).ready(function() {
    ...
    function createSiteDetail(siteId){
        ...
        .done(function(result) {
            ...
            html += '        </div>\n';
            html += '        <h4 class="box-title">Coordinate geografiche</h4>\n';
            html += '        <hr class="m-t-0 m-b-20">\n';
            html += '        <div class="form-group row">\n';
            html += '            <label for="" class="control-label col-2 col-form-label">Regione</label>\n';
            html += '            <div class="col-4 view-param">'+site.region_name+'</div>\n';
            html += '            <label for="" class="control-label col-2 col-form-label">Provincia</label>\n';
            html += '            <div class="col-4 view-param">'+site.province_name+'</div>\n';
            html += '        </div>\n';
            html += '        <div class="form-group row">\n';
            html += '            <label for="" class="control-label col-2 col-form-label">Comune</label>\n';
            html += '            <div class="col-4 view-param">'+site.municipality_name+'</div>\n';
            html += '            <label for="" class="control-label col-2 col-form-label">Località</label>\n';
            html += '            <div class="col-4 view-param">'+site.site_locality+'</div>\n';
            html += '        </div>\n';
            html += '        <div class="form-group row">\n';
            html += '            <label for="" class="control-label col-2 col-form-label">WGS84 latitudine</label>\n';
            html += '            <div class="col-4 view-param">'+site.site_wgs84_lat+'</div>\n';
            html += '            <label for="" class="control-label col-2 col-form-label">WGS84 longitudine</label>\n';
            html += '            <div class="col-4 view-param">'+site.site_wgs84_lon+'</div>\n';
            html += '        </div>\n';
            html += '        <div class="form-group row">\n';
            html += '            <label for="" class="control-label col-2 col-form-label">Quota</label>\n';
            html += '            <div class="col-4 view-param">'+formatTextField(site.site_altitude)+' m.s.l.m.</div>\n';
            html += '        </div>\n';
