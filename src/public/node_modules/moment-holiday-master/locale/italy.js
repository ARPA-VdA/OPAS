...
(function() {
  ...
  moment.holidays.italy = {
    ...
    "Pasquetta": {
      date: 'easter+1',
      keywords_y: ['pasquetta'],
      keywords: ['lunedì', 'angelo']
    },
    "Festa della Liberazione": {
      date: '4/25',
      keywords_y:['liberazione'],
      keywords: ['aprile']
    },
    "Festa del lavoro": {
      date: '5/1',
    ...
    "Festa della Repubblica" : {
      date: '6/2',
      keywords_y: ['repubblica'],
      keywords: ['giugno']
    },
    "Ferragosto": {
      date: '8/15',
      keywords: ['assunzione', 'agosto']
    },
    "Tutti i Santi": {
      date: '11/1',
      keywords: ['primo', 'novembre', 'santi']
    },
