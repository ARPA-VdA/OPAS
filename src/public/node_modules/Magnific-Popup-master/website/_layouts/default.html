...
<html lang="en" prefix="og: http://ogp.me/ns#">
  <head>
    ...
    {% if site.url == 'local' %}
      ...
      <link href="assets/magnific-popup.css?v={{site.mfpversion}}" rel="stylesheet" />
    {% else %}
  ...
  {% if page.addjs %}
    {% if site.url == 'local' %}
      ...
      <script src="assets/jquery.magnific-popup.js?v={{site.mfpversion}}"></script>
    {% else %}
      <script>
        document.write('<script src=third-party-libs/' +
        ('__proto__' in {} ? 'zepto' : 'jquery') +
      ...
      <script src="assets/jquery.magnific-popup.min.js?v={{site.mfpversion}}"></script>
    {% endif %}
  {% endif %}
