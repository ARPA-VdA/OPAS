...
```jsonc
{
  ...
  "AutoReconnectSeconds": 60,             // se nessun canale riceve dati reali per questo numero di secondi, run_driver() richiama automaticamente disconnect() e poi connect(); 0 disabilita il controllo — solo SDK
