...
```jsonc
{
  ...
  "AutoReconnectSeconds": 60,             // if no channel gets real data for this many seconds, run_driver() calls disconnect() then connect() again automatically; 0 disables it — SDK only
