...
contextBridge.exposeInMainWorld("electron", {
    ...
    exportSettings: () => ipcRenderer.invoke("exportSettings"),
    ...
    setFavoriteView: (id: string, favorite: boolean) => ipcRenderer.invoke("setFavoriteView", id, favorite),
    ...
    openGraphsWindow: (panel: any) => ipcRenderer.invoke("openGraphsWindow", panel),
    ...
    getUiDocs: (lang: string) => ipcRenderer.invoke("getUiDocs", lang)
