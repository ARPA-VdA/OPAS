...
export const GraphPanel = forwardRef<GraphPanelHandle, GraphPanelProps>(function GraphPanel(
  ...
  const [kind, setKind] = useState<HistoryKind>('raw')
  const [fromDateTime, setFromDateTime] = useState(startOfTodayLocalDateTime())
  const [toDateTime, setToDateTime] = useState(formatLocalDateTime(new Date()))
